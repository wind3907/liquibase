...
**    BY_FUTURE_UPD_TIME to BATCH table.
...
BEGIN
   ...
   IF v_column_exists = 0 THEN
      EXECUTE IMMEDIATE 'ALTER TABLE BATCH ADD BY_COMPLETE_GOAL_TIME NUMBER(8,2) DEFAULT 0';
   END IF;
END;
/
...
BEGIN
   ...
   IF v_column_exists = 0 THEN
      EXECUTE IMMEDIATE 'ALTER TABLE BATCH ADD BY_SWMS_GOAL_TIME NUMBER(8,2) DEFAULT 0';
   END IF;
END;
/
...
BEGIN
   ...
   IF v_column_exists = 0 THEN
      EXECUTE IMMEDIATE 'ALTER TABLE BATCH ADD BY_FUTURE_GOAL_TIME NUMBER(8,2) DEFAULT 0';
   END IF;
END;
/
...
BEGIN
   ...
   IF v_column_exists = 0 THEN
      EXECUTE IMMEDIATE 'ALTER TABLE BATCH ADD BY_COMPLETE_UPD_TIME DATE';
   END IF;
END;
/
...
BEGIN
   ...
   IF v_column_exists = 0 THEN
      EXECUTE IMMEDIATE 'ALTER TABLE BATCH ADD BY_FUTURE_UPD_TIME DATE';
   END IF;
END;
/