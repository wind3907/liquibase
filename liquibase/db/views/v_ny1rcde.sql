...
--
-- Used by:
--    Reports NY1RC (Net Item Cost Variance), NY1RD (Total Piece Item
--    Variance), NY1RE (Item Description Variance)
--
...
--
------------------------------------------------------------------------------
CREATE OR REPLACE VIEW swms.v_ny1rcde AS
  SELECT t.prod_id prod_id, 
