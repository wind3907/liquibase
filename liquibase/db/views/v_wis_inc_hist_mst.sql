------------------------------------------------------------------------------
-- sccs_id=@(#) src/schema/views/v_wis_inc_hist_mst.sql, swms, swms.9, 10.1.1 9/7/06 1.2
--
-- View:
--    v_wis_inc_hist_mst
--
...
------------------------------------------------------------------------------
create or replace view swms.v_wis_inc_hist_mst as
...
group by USER_ID,USER_NAME,SEND_DATE,SEND_USER
/
